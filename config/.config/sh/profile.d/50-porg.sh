...
if [ -e $PORG_ROOT ]; then
  ...
  export CPATH=/usr/include:$PORG_ROOT/usr/include:$CPATH
  export C_INCLUDE_PATH=/usr/include:$PORG_ROOT/usr/include:$C_INCLUDE_PATH
  export CPLUS_INCLUDE_PATH=/usr/include:$PORG_ROOT/usr/include:$CPLUS_INCLUDE_PATH
